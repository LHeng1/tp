...
|--------------------------|------------------------------------------------|-----------------------------------------------------|----------------------------------------------------------------------------------------|
| Amy Ling                 | ![img_8.png](img_8.png)                        | N/A                                                 | Completed the initially assigned sections and duties as per the agreed-upon allocation |
| Lim Heng Yi              | ![img_9.png](img_9.png)                        | N/A                                                 | Completed the initially assigned sections and duties as per the agreed-upon allocation |
| Amos Ting                | ![img_10.png](img_10.png)                      | N/A                                                 | Completed the initially assigned sections and duties as per the agreed-upon allocation |
| Nabonita Sen             | ![img_13.png](img_13.png)                      | N/A                                                 | Completed the initially assigned sections and duties as per the agreed-upon allocation |
| Kok Chan Hong            | ![img_12.png](img_12.png)                      | N/A                                                 | Completed the initially assigned sections and duties as per the agreed-upon allocation |
